...
Public Class Codec
    ...
    Public Function GetTags(FilePath As String) As ReturnObject
        ...
        Select Case Me.Name
            Case Is = "FLAC"
                Try
                    ...
                    For Each FieldName As String In Xiph
                        TagList.Add(New Tag(FieldName, Xiph.GetField(FieldName)(0)))
                    Next

                    Return New ReturnObject(True, "", TagList.ToArray)
                Catch generatedExceptionName As UnsupportedFormatException
                    Return New ReturnObject(False, generatedExceptionName.Message, Nothing)
                End Try
            Case Else
                Return New ReturnObject(False, "Codec type not found.", Nothing)
        End Select

    End Function

    Public Function MatchTag(FilePath As String, Tags As Tag()) As ReturnObject
