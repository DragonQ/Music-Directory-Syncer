...
Module XML
    ...
    Public Function SaveSyncSettings(MyGlobalSyncSettings As GlobalSyncSettings) As ReturnObject
        ...
        Try
            ...
            'Create StringWriter to store XML text (will be disposed by XmlWriter dispose below)
            ...
            Using MyWriter As XmlWriter = XmlWriter.Create(FileData, XMLSettings)
                ...
                MyWriter.WriteElementString("LogLevel", MyGlobalSyncSettings.GetLogLevelString())
